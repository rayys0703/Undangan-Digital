                                ...
                                <div class="flex-none w-44 md:w-56 relative bg-gray-50 rounded-s-2xl">
                                    <label for="uploadInput"
                                        ...
                                        <input id="uploadInput" type="file" class="hidden"
                                            accept=".png, .jpg, .jpeg, .gif" name="image" />
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <button id="closeButton" class="hidden absolute p-1 top-3 right-3 text-white bg-violet-700 hover:bg-violet-500 rounded-full shadow-xl"><svg class='fill-none stroke-2 stroke-white w-4 h-4' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'><g transform='translate(3.500000, 2.000000)'><path d='M15.3891429,7.55409524 C15.3891429,15.5731429 16.5434286,19.1979048 8.77961905,19.1979048 C1.01485714,19.1979048 2.19295238,15.5731429 2.19295238,7.55409524'></path><line x1='16.8651429' y1='4.47980952' x2='0.714666667' y2='4.47980952'></line><path d='M12.2148571,4.47980952 C12.2148571,4.47980952 12.7434286,0.714095238 8.78914286,0.714095238 C4.83580952,0.714095238 5.36438095,4.47980952 5.36438095,4.47980952'></path></g></svg></button>
                                    </div>
                                    <script>
                                    ...
                                    // Hide the uploaded image and close button
                                    ...
                                    <div class="flex flex-wrap">
                                        <h1 class="flex-auto font-medium text-xl text-slate-900">
                                            <input type="text" id="first_name"
                                                ...
                                                placeholder="Nama Template" name="name" required>
                                        </h1>
                                        <div class="w-full flex-none mt-2 order-1 text-3xl font-bold text-violet-600">
                                            <div class="flex gap-5">
                                                ...
                                                <input type="text" id="first_name"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                                    placeholder="000" name="price" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mt-4 flex items-baseline mb-2 pb-4 border-b border-slate-200">
                                        <textarea rows="2"
                                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                                            placeholder="Deskripsi Template" name="desc"></textarea>
                                    </div>
                                    <div class="mt-0 flex flex-col items-baseline mb-4">
                                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Upload file .blade.php</label>
                                        <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_help" id="file" name="file" type="file" accept=".php">
                                    </div>
